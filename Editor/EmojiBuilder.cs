...
public class EmojiBuilder  {
	...
	private const string OutputPath = "Assets/Res/Font/";
	private const string InputPath = "/TempIcon/";
	...
	public static void BuildEmoji()
	{
		...
		string outputfile1 = Application.dataPath + InputPath + "emoji_tex.png";
		File.WriteAllBytes (outputfile1, bytes1);

		byte[] bytes2 = dataTex.EncodeToPNG ();
		string outputfile2 = Application.dataPath + InputPath + "emoji_data.png";
		File.WriteAllBytes (outputfile2, bytes2);

		using (StreamWriter sw = new StreamWriter (Application.dataPath+InputPath + "emoji.txt",false)) {
